...
// ----------------------------------
// 7) Linear Ground Friction
// ----------------------------------

if (round(velocityX) != 0)
{
    var frictionApplied = sign(velocityX) * 0.8;
